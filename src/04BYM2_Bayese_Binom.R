...
data_list <- list(
  ...
  nstar = vb12_inad_lga_complete$n_eff,
...
fit$save_output_files(dir = here('outputs','mcmc'), basename = "stan_postsample_vb12_BYM2_arealbinom")
csv_files <- fit$output_files()
saveRDS(csv_files,here('outputs','mcmc','csv_files_postsample_vb12_BYM2_arealbinom.rds'))
...
FB_map
tmap_save(FB_map, "outputs/maps/vb12_inad_FB_BYM2_arealbinom.png", width = 8, height = 8,
          units = "in", dpi = 600)
